            ...
            <table className={CSS['table']}>
                <thead>
                    <tr>
                        ...
                        <th className={`${CSS['table-head-row']} ${CSS['table-head-btn']}`}>Delete Producct</th>
                    </tr>
                </thead>
                <tbody>
                    {products.map((product) => (
                        <tr key={product._id}>
                            ...
                            <td className={CSS['table-data']}>
                                <button className={CSS['table-data-delete-btn']} type='button' onClick={() => handleDeleteProduct(product._id)}>Delete</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
